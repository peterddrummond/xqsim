function e = xqsim_experiment( )

%SET INPUT DATA PARAMETERS

p.name      = 'Exp:ens=1.2e6, t=1.0061, e=0.138';%Choose the run name
...
%p.ensembles = [1000,100,12];                     %long repeats for errors
p.ensembles = [100,20,1];                       %repeats for errors
p.t         = 1.0061;                            %transmission correction
