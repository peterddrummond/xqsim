...
%Tests +P,W and Q phase-space 
%Uses squeezed and thermal inputs, multiple signatures
%Matrix size      = 20*20
%Sequence length  = 12
%Total tests      = 68
%Total graphs     = 152
%Chi-square error = 1.2
%Xqsim timing     = 30s
...
[e1,d,p]     = xqsim(p0,p1,p2,p3,pW,p1W,p2W,p3W,pQ,p1Q,p2Q,p3Q);%xgraph(d,p);
%[e1,d,p]     = xqsim(p3,p3W,p3Q);%xgraph(d,p);
%[e1,d,p]     = xqsim(p3);xgraph(d,p);
%xgraph(d,p);
