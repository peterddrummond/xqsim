function [] =  xplot3(x1,x2,x3,lab1,lab2,lab3,imhead,n,ax,g)
%   XPLOT3(x1,x2,x3,lab1,lab2,lab3,imhead,n,ax,g)
...
%   plot limits are set using the xlimit function, depending on g.limit{n}
%   Licensed by Peter D. Drummond, (2020) - see License.txt 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

ax = [ax(1:2),ax(end)];                        %%restore data axis
x3 = max(x3, g.cutoffs{n});                    %%include z cut-off
